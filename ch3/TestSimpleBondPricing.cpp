...
//  cout.setf(0, ios_base::floatfield);
  ...
  cout << "Continuous Compounding: " << FutureValueContinuous(P0, nPeriods, r) << endl;

  double rc = 0.5;
  double rm = ContinuousToDiscreteRate(rc, m);
  cout << "Continuous to discrete: " << rm << endl;
  cout << "Discrete to continuous: " << DiscreteToContinuousRate(rm, m) << endl;
